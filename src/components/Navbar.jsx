                        ...
                        {currentUser && userProfile?.role === 'user' && (
                            <div className="hidden md:flex items-center gap-1">
                                ...
                                <Link
                                    ...
                                    className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${currentTab === 'profile' ? 'bg-slate-100 text-blue-700' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-50'}`}
                                >
                                    Profile
                                </Link>
                            </div>
